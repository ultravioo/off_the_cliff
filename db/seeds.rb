...
casacada = Trail.create(name: "Cascada Palo Maria", distance: 3, duration: 3_600, elevation: 148, difficulty: "Beginner", description: "Check out this 2.7-km out-and-back trail near Puerto Vallarta, Jalisco. Generally considered an easy route, it takes an average of 59 min to complete ",location: "Mexico", user: user)
...
naiguata = Trail.create(name: "Naiguata Peak", distance: 16, duration: 32_400, elevation: 1881, difficulty: "Pro", description: "Traditional route of ascent to the peak taking the path through PGP La Julia and following the La Julia - Mirador del Edén trail, upon reaching the viewpoint, take the Dos Banderas trail to the top of Topo Dos Banderas, continuing the ascent along the path towards the Topo Goering, Topo Galindo and finally on the way up to the top of Pico Naiguatá.",location: "Venezuela", user: user4)
...
humboldt = Trail.create(name: "Pico Humboldt", distance: 3, duration: 5_400, elevation: 400, difficulty: "Pro", description: "Two of the highest peaks of Venezuela. Very hard and vey steep. Would recommend for pro and highly equiped.",location: "Venezuela", user: user4)
url20 = URI.open('https://res.cloudinary.com/rubberd/image/upload/v1654528384/offthecliff/sT8nzy80_sfrng2.jpg')
naiguata.photo.attach(io: url20, filename: '20.jpg', content_type: 'images/jpg')
